...
class TrackAppOpenEvent @Inject constructor(
    private val eventsRepository: EventsRepository
) {

    suspend operator fun invoke(isNewSession: Boolean): Either<DataError, Unit> =
        eventsRepository.sendEvent(AppEvent.AppOpen(isNewSession))
}
