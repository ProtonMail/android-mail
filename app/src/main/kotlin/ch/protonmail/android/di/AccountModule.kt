...
object AccountManagerModule {
    ...
    @Provides
    @Singleton
    fun provideKeyStoreCrypto(): KeyStoreCrypto = AndroidKeyStoreCrypto.default

    @Provides
    @Singleton
    fun provideCryptoContext(
        keyStoreCrypto: KeyStoreCrypto
    ): CryptoContext = AndroidCryptoContext(keyStoreCrypto)
    ...
    fun provideAccountRepository(
        ...
        db: AccountDatabase,
        keyStoreCrypto: KeyStoreCrypto
    ): AccountRepository = AccountRepositoryImpl(product, db, keyStoreCrypto)
    ...
    fun provideSessionManager(
        ...
        authRepository: AuthRepository
    ): SessionManager = SessionManagerImpl(sessionProvider, sessionListener, authRepository)
}
