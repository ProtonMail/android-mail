...
internal class MessageModeAppendItemsTests :
        ...
        mockWebServer.dispatcher = mockNetworkDispatcher(useDefaultMailSettings = false) {
            addMockRequests(
                "/mail/v4/settings"
                    ...
                    withStatusCode 200,
                "/mail/v4/messages?Page=0&PageSize=75&Limit=75&LabelID=0&Sort=Time&Desc=1"
                    respondWith "/mail/v4/messages/messages_189114_1.json"
                    withStatusCode 200 serveOnce true,
                "/mail/v4/messages?Page=0&PageSize=25&Limit=25&LabelID=0&Sort=Time&Desc=1&End=1687181980&EndID=Ipolvuzgp9N-3XwngHmiQZ9fDZV3CUSv65Pi3SjL75I_-mhS4sxdT2qNo5-GEoLuFuzInClxbq3tKM9MydlQzQ%3D%3D"
                    respondWith "/mail/v4/messages/messages_189114_2.json"
                    withStatusCode 200 serveOnce true,
                "/mail/v4/messages?Page=0&PageSize=25&Limit=25&LabelID=0&Sort=Time&Desc=1&End=1678107386&EndID=Q0bXXG7rlW34PI8sKXbIliVZ2ybuoIefe933RlbTZYrjpl1nsWG7FKTAW7s4nnskarFkbvpPVOESe0omarcHsQ%3D%3D"
