...
internal class SmokeTestExtendedFilter : AbstractFilter() {

    override fun shouldRun(description: Description): Boolean = super.shouldRun(description)

    override fun describe(): String = "Filters smoke extended tests only"

    override fun evaluateTest(description: Description): Boolean {
        return description.hasAnnotation(SmokeExtendedTest::class.java) ||
