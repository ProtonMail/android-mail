...
package ch.protonmail.android.uitest.robot.device
...
import me.proton.core.test.android.instrumented.utils.Shell.sendShareFileIntent
...
open class DeviceRobot {
    ...
    fun clickRecentAppView(): DeviceRobot {
        ...
        device.findObject(recentAppSelector).waitForExists(TIMEOUT_5S)
