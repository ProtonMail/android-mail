...
class ResetSettingsActions @Inject constructor(
    private val repo: InMemoryToolbarPreferenceRepository
) {

    operator fun invoke(tab: SettingsToolbarType) = repo.resetToDefault(tab)
}
