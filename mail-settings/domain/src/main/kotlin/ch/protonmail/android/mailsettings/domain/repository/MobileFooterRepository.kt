...
interface MobileFooterRepository {

    suspend fun getMobileFooter(userId: UserId): Either<DataError, MobileFooter>

    suspend fun updateMobileFooter(userId: UserId, preference: MobileFooterPreference): Either<DataError, Unit>
}
