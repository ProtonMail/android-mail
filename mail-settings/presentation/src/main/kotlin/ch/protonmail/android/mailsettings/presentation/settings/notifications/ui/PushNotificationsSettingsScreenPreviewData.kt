...
internal object PushNotificationsSettingsScreenPreviewData {

    val state = PushNotificationsSettingsState.DataLoaded(
        PushNotificationsSettingsState.ExtendedNotificationState(ExtendedNotificationsSettingUiModel(false)),
