...
sealed interface CustomizeToolbarOperation {

    data class TabSelected(val tabIdx: Int) : CustomizeToolbarOperation

    data class ActionSelected(val actionId: String) : CustomizeToolbarOperation

    data class ActionRemoved(val actionId: String) : CustomizeToolbarOperation
