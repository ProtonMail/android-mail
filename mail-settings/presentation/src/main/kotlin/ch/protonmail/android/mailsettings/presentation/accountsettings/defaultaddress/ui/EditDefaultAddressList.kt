...
fun EditDefaultAddressList(
    ...
    Column(modifier = modifier) {
        ActiveAddressesList(
            state = state.activeAddressesState,
            updateErrorState = state.updateErrorState,
            actions = actions
        )
        InactiveAddressesHeader()
        InactiveAddressesList(state = state.inactiveAddressesState)
    }
}
