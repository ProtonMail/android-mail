...
@Composable
internal fun UnselectedToolbarActionDisplay(
    ...
    Column(modifier = modifier) {
        Row(
            ...
            IconButton(onClick = onAddClicked, enabled = model.enabled) {
                Icon(
                    painter = painterResource(id = R.drawable.ic_proton_plus_circle_filled),
                    tint = ProtonTheme.colors.notificationSuccess.modifyAlpha(model.enabled),
...
@Composable
private fun UnselectedToolbarActionEnabledPreview(
