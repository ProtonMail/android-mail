...
internal object MessageDetailFooterPreviewData {
...
internal data class MessageDetailFooterPreview(
    val uiModel: MessageDetailFooterUiModel
)

internal class MessageDetailFooterPreviewProvider : PreviewParameterProvider<MessageDetailFooterPreview> {

    override val values = sequenceOf(
        MessageDetailFooterPreview(
            uiModel = MessageDetailFooterPreviewData.ReplyAll
        ),
        MessageDetailFooterPreview(
