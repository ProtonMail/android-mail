...
import ch.protonmail.android.maildetail.presentation.model.MessageDetailEvent.ReportPhishingRequested
import ch.protonmail.android.maildetail.presentation.model.MessageDetailOperation
import ch.protonmail.android.maildetail.presentation.model.MessageViewAction
import ch.protonmail.android.maildetail.presentation.model.ReportPhishingDialogState
import javax.inject.Inject

class MessageReportPhishingDialogReducer @Inject constructor() {

    internal fun newStateFrom(operation: MessageDetailOperation.AffectingReportPhishingDialog) = when (operation) {
        is MessageViewAction.ReportPhishingDismissed,
        is MessageViewAction.ReportPhishingConfirmed -> ReportPhishingDialogState.Hidden
