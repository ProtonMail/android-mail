...
class ShouldShowRemoteContentTest {

    private val mailSettingsRepository = mockk<MailSettingsRepository>()

    private val shouldShowRemoteContent = ShouldShowRemoteContent(mailSettingsRepository)

    @Test
    fun `should not show remote content when repository returns None as the setting value`() = runTest {
        // Given
        coEvery {
        ...
        // When
        val actual = shouldShowRemoteContent(UserIdTestData.userId)
    ...
    @Test
    fun `should show remote content when repository returns Remote as the setting value`() = runTest {
        // Given
        coEvery {
            mailSettingsRepository.getMailSettings(UserIdTestData.userId)
    ...
    @Test
    fun `should not show remote content when repository returns Embedded as the setting value`() = runTest {
        // Given
        coEvery {
            mailSettingsRepository.getMailSettings(UserIdTestData.userId)
    ...
    @Test
    fun `should show remote content when repository returns Both as the setting value`() = runTest {
        // Given
        coEvery {
            mailSettingsRepository.getMailSettings(UserIdTestData.userId)
    ...
    @Test
    fun `should not show remote content when repository returns null as the setting value`() = runTest {
        // Given
        coEvery {
            mailSettingsRepository.getMailSettings(UserIdTestData.userId)
