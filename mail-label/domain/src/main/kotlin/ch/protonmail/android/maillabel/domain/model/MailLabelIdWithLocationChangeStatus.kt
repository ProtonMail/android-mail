...
fun MailLabelIdWithLocationChangeStatus.isRequested(): Boolean =
    locationChangeStatus == LocationChangeStatus.LocationRequested

fun MailLabelIdWithLocationChangeStatus.isLoaded(): Boolean =
    locationChangeStatus == LocationChangeStatus.LocationLoaded
