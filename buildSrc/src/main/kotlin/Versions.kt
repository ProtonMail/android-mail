object Versions {
    ...
    object Core {
        const val account = "1.15.2"
        const val accountManager = "1.16.2"
        const val auth = "1.18.3"
        const val contact = "1.19.1"
        const val country = "1.16.2"
        const val crypto = "1.16"
        const val data = "1.15"
        const val dataRoom = "1.16"
        const val domain = "1.18"
        const val eventManager = "1.19.1"
        const val humanVerification = "1.16.3"
        const val key = "1.16.1"
        const val mailSettings = "1.19.1"
        const val network = "1.15.7"
        const val payment = "1.17.3"
        const val plan = "1.18.2"
        const val presentation = "1.18.3"
        const val user = "1.19.1"
        const val userSettings = "1.19.1"
