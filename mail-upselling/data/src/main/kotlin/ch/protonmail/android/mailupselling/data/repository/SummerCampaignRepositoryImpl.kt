...
class SummerCampaignRepositoryImpl @Inject constructor(
    private val dataSource: SummerCampaignLocalDataSource
) : SummerCampaignRepository {

    override fun observePhaseEligibility(phase: SummerCampaignPhase.Active) = dataSource.observePhaseEligibility(phase)

    override suspend fun saveSeen(phase: SummerCampaignPhase.Active): Either<PreferencesError, Unit> =
        dataSource.saveSeen(phase)
}
