...
class SpringPromoRepositoryImpl @Inject constructor(
    private val dataSource: SpringPromoLocalDataSource
) : SpringPromoRepository {

    override fun observePhaseEligibility(phase: SpringPromoPhase.Active) = dataSource.observePhaseEligibility(phase)
