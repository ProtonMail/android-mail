...
internal class UpsellingBottomSheetViewModelTest {
    ...
    fun `should emit loading state at start`() = runTest {
        ...
        viewModel.state.test {
            assertEquals(UpsellingBottomSheetContentState.Loading, awaitItem())
        }
    }
    ...
    fun `should emit error when user is null`() = runTest {
        ...
        // When + Then
        viewModel.state.test {
            assertIs<UpsellingBottomSheetContentState.Error>(awaitItem())
        }
    }
    ...
    fun `should emit data when there are subscriptions`() = runTest {
        ...
        // When + Then
        viewModel.state.test {
            assertIs<UpsellingBottomSheetContentState.Data>(awaitItem())
        }
    }
