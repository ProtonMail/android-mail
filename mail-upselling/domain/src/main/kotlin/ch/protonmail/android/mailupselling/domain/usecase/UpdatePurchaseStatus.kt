...
@Singleton
class UpdatePurchaseStatus @Inject constructor(
    private val repository: CurrentPurchaseStatusRepository
) {

    suspend operator fun invoke(update: PurchaseStatusUpdate) = repository.onNewUpdate(update)
}
